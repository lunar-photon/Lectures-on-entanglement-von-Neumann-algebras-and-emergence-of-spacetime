# Entanglement, Operator Algebras, and the Emergence of Spacetime
### A First Introduction for Physicists

Self-contained notes for readers who know linear algebra and undergraduate quantum mechanics. It explains why the tensor-product picture of a subsystem breaks down for quantum fields, many-body systems and gravity, develops the replacement (von Neumann algebras, the GNS construction, modular theory, the crossed product) from the beginning, and applies it to holography and simple models of quantum gravity.

Each new construction is checked against a calculation you already know from ordinary quantum mechanics. Every calculation is written as a chain of equalities whose numbered steps are explained immediately after the chain. The logical development follows H. Liu, *Lectures on entanglement, von Neumann algebras, and emergence of spacetime* (arXiv:[2510.07017](https://arxiv.org/abs/2510.07017)); other sources are listed in the Preface.

---

## 📖 Available Formats for Reading & Accessibility

To make the notes accessible on any device, screen reader, or operating environment, multiple formats are provided:
...
| **📄 PDF** | [`main.pdf`](main.pdf) | **Print & Desktop Reading**. Latin Modern typography, `microtype` optical alignment, running headers/footers, clickable bookmarks & TOC, and styled callout boxes. |
| **📝 Markdown Edition** | [`markdown/`](markdown/) | **Terminal, Obsidian & Plain Text**. Individual chapter files (`01_introduction.md` through `10_conclusions.md`) plus [`full_notes.md`](markdown/full_notes.md). |
...
```mermaid
flowchart TD
    subgraph Part1["Part I: Operator Algebras & Entanglement (Chapters 1–5)"]
    ...
    subgraph Part2["Part II: Holography & Emergence of Spacetime (Chapters 6–10)"]
...
### [Chapter 1: Introduction and Motivations](markdown/01_introduction.md)
...
### [Chapter 2: Introduction to von Neumann Algebras](markdown/02_von_neumann_algebras.md)
...
### [Chapter 3: Type I and II Algebras & Entanglement](markdown/03_type_I_and_II.md)
...
### [Chapter 4: Type III Algebras & Modular Theory](markdown/04_type_III_modular_theory.md)
...
### [Chapter 5: Crossed Product by Modular Group](markdown/05_crossed_product.md)
...
### [Chapter 6: AdS/CFT Duality in the Large-$N$ Limit](markdown/06_adscft_large_N.md)
...
### [Chapter 7: Subregion-Subalgebra Duality](markdown/07_subregion_subalgebra_duality.md)
...
### [Chapter 8: Emergence of Spacetime & Bulk Causality](markdown/08_emergence_of_spacetime.md)
...
### [Chapter 9: Quantum Gravity Regimes & Solvable Toy Models](markdown/09_quantum_gravity_regimes.md)
...
### [Chapter 10: Conclusions & Discussions](markdown/10_conclusions.md)
...
### 3. View the Interactive Web Edition
